...
const Features = () => {
  ...
  return (
    <section className=' h-full commom-padding bg-zinc relative overflow-hidden'>
      <div className='screen-max-width'>
        <div className=' mb-12 w-full'>
            <h1 id='features_title' className='section-heading pt-5 pl-4 '>Explore the full story</h1>
                        ...
                        <div className=' flex-1 flex-center'>
                          <p className=' feature-text g_text'>
                            ...
                            <span className='text-white'>
                              the first iPhone to featire an aerospace grade titanium design  </span>
